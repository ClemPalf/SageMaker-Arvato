...
def model_fn(model_dir):
    ...
    model = BinaryClassifier(model_info['input_dim'], model_info['hidden_dim1'], model_info['hidden_dim2'], model_info['hidden_dim3'], model_info['output_dim'])
